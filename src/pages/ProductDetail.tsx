      ...
      {product && (
        <SEO
          ...
          breadcrumbItems={[
            ...
            { name: product.category.charAt(0).toUpperCase() + product.category.slice(1), url: `https://www.tubhyam.in/shop?category=${product.category}` },
            { name: product.name, url: `https://www.tubhyam.in/product/${product.id}` }
          ]}
        />
      )}
      <Navbar />
