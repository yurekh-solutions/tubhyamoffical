    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 glass-card px-4 py-2 animate-fade-in-up">
          ...
          {/* Stats */}
          <div className="flex items-center gap-8 pt-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div>
