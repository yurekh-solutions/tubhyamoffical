...
const AIChatWidget = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm Tubhyam's AI shopping assistant. How can I help you today? You can ask me about products, order tracking, sizing, or anything else!",
      timestamp: new Date()
    }
  ]);
        ...
        <Card className="fixed bottom-6 right-6 z-50 w-[400px] max-w-[calc(100vw-3rem)] h-[600px] max-h-[calc(100vh-3rem)] shadow-2xl flex flex-col border-2 border-primary/20">
          ...
          <CardHeader className="bg-primary text-primary-foreground p-4 flex-shrink-0">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">Tubhyam Assistant</CardTitle>
          ...
          <div className="p-4 border-t border-border flex-shrink-0">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">
              Powered by Tubhyam AI • <a href="https://wa.me/917039382706" className="underline">WhatsApp Support</a>
            </p>
          </div>
        </Card>
      )}
